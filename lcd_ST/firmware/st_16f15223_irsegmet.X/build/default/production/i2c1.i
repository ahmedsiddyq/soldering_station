...
static _Bool I2C1_PutByte(uint8_t b)
{
    I2C1_WaitIdle();
    SSP1BUF = b;
    I2C1_WaitIdle();
...
static uint8_t I2C1_GetByte(_Bool ackIt)
{
    I2C1_WaitIdle();
    SSP1CON2bits.RCEN = 1;
...
# 92 "i2c1.c"
    ...
    SSP1ADD = (uint8_t)(((32000000UL / 4UL) / 100000UL) - 1UL);
...
_Bool I2C1_Write(uint8_t addr7, const uint8_t *data, uint8_t len)
{
    ...
    I2C1_Start();
    ok = I2C1_PutByte((uint8_t)(addr7 << 1) | 0u);
...
_Bool I2C1_Read(uint8_t addr7, uint8_t *data, uint8_t len)
{
    ...
    I2C1_Start();
    _Bool ok = I2C1_PutByte((uint8_t)(addr7 << 1) | 1u);
    if (!ok) {
        I2C1_Stop();
        return 0;
    }
    ...
    for (uint8_t i = 0; i < len; i++) {
        _Bool lastByte = (i == (len - 1));
        data[i] = I2C1_GetByte(!lastByte);
    }
